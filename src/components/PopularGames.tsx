...
const GAMES = [
  { img: cardLive, title: "Live Cricket Betting", to: "/cricket", alt: "play online games on khelo24bets.live" },
  { img: cardAndar, title: "Aviator", to: "/aviator", alt: "free cricket ID on khelo24bets.live" },
  { img: cardTeen, title: "Teen Patti", to: "/teen-patti", alt: "get your ID and play now at khelo24bets.live" },
];
