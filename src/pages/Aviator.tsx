...
const Aviator = () => {
  useSeo({
    ...
    canonical: "/aviator",
    keywords: "aviator game online, crash game, khelo24bet aviator, play aviator",
  });
