...
const Cricket = () => {
  useSeo({
    ...
    canonical: "/cricket",
    keywords: "live cricket betting, cricket betting online, khelo24bet cricket, best cricket odds",
  });
      ...
      <section className="container py-12 md:py-20">
        ...
        <div className="mt-10 max-w-3xl">
          ...
          <p className="text-muted-foreground leading-relaxed mb-3">
            Khelo24Bet is among the <strong className="text-foreground">best cricket prediction sites online</strong> where you get <strong className="text-foreground">live cricket betting tips online</strong> powered by data-driven analysis. Our <strong className="text-foreground">khelo24bet online platform</strong> covers IPL, T20 World Cup, Asia Cup and all international matches with the best odds.
          </p>
