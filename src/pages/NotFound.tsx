...
const NotFound = () => {
  ...
  useSeo({
    title: "Page Not Found — Khelo24Bets",
    description: "The page you're looking for doesn't exist. Browse our games, betting guides, or contact 24x7 support on Khelo24Bets.",
    canonical: "/404",
    keywords: "khelo24bets, page not found, 404",
  });
