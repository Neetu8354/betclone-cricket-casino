...
const BLOGS = [
  { slug: "/blog/how-to-login-khelo24bets", title: "How to Login Khelo24Bets Step by Step Guide 2026", desc: "Complete step by step guide on how to login khelo24bets with username." },
  { slug: "/blog/how-to-use-khelo24bets-online", title: "How to Use Khelo24Bets Online — Complete Guide", desc: "Learn how to use khelo24bets online platform and start playing instantly." },
...
const BlogListing = () => {
  useSeo({
    title: "Blog — Khelo24Bets | Sports Gaming Tips & Guides",
    description: "Read the latest tips, guides and strategies for online sports gaming on Khelo24Bets. Cricket betting tips, Aviator strategies, login guides and more.",
    canonical: "/blog",
  ...
  return (
    <main>
      ...
      <section className="container py-12 md:py-20">
        ...
        <p className="text-muted-foreground max-w-2xl mb-10">Tips, strategies and step-by-step guides to help you win more on Khelo24Bets.</p>
